...
#include <tchar.h>
#include <string>
#include "../Reservation/AddReservation/AddReservation.h"
#include "../Reservation/ShowReservation/ShowReservation.h"
...
private:
    ...
    static LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
    {
        ...
        MainWIndow* win = reinterpret_cast<MainWIndow*>(GetWindowLongPtr(hwnd, GWLP_USERDATA));
        ...
        case WM_CREATE:
            ...
            AddButton(L"Ajouter", 10, 500, 100, 20, hwnd, 1);
            AddButton(L"Afficher", 200, 500, 100, 20, hwnd, 2);


            break;
        case WM_COMMAND:
            /*AddReservation* add = nullptr;
            ShowReservation* show = nullptr;
            switch (LOWORD(wParam)) {
            case 1:
                add = new AddReservation();
                break;
            case 2:
                show = new ShowReservation();
                break;
            }*/
            break;
        case WM_CLOSE:
